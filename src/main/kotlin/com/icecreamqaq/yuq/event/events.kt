...
open class GroupMemberEvent() : Event()
open class GroupMemberRequestEvent(val group: Group, val qq: Long, val name: String, val message: String) : GroupMemberEvent(), CancelEvent {
    override fun cancelAble() = true
    var accept = false
}
